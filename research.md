...
## Social?
Given the abundance of textual communication online, social problems can now be studied using large-scale NLP methods. Currently, I’m interested in better understanding prejudice on social media. How are bigoted ideas discussed online? How do bigoted ideas spread? I am also interested in developing methods that can persuade people to contemplate their bigoted views.
